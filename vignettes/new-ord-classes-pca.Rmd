---
title: "new-ord-classes-pca"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{new-ord-classes-pca}
...
The process demonstrated in this vignette follows `vignette("new-ord-classes-class-support-checklist")`.
